...
-- Insérer des données de vente pour le mois de janvier 2024
INSERT INTO "public".vente (id_point_vente, id_chariot, id_produit, quantite, date_vente)
VALUES
    (1, 1, 1, 2, '2024-01-01'),
    (1, 2, 2, 3, '2024-01-02'),
...
-- Insérer des données de vente pour le mois de février 2024
INSERT INTO "public".vente (id_point_vente, id_chariot, id_produit, quantite, date_vente)
VALUES
    (1, 1, 1, 8, '2024-02-01'),
    (1, 2, 2, 3, '2024-02-02'),
...
-- Insérer des données de vente pour le mois de mars 2024
INSERT INTO "public".vente (id_point_vente, id_chariot, id_produit, quantite, date_vente)
VALUES
    (1, 1, 1, 4, '2024-03-01'),
    (1, 2, 2, 7, '2024-03-02'),
...
-- Insérer des données de vente pour le mois d'avril 2024
INSERT INTO "public".vente (id_point_vente, id_chariot, id_produit, quantite, date_vente)
VALUES
    (1, 1, 1, 8, '2024-04-01'),
    (1, 2, 2, 5, '2024-04-02'),
...
-- Insérer des données de vente pour le mois de mai 2024
INSERT INTO "public".vente (id_point_vente, id_chariot, id_produit, quantite, date_vente)
VALUES
    (1, 1, 1, 5, '2024-05-01'),
    (1, 2, 2, 8, '2024-05-02'),
...
-- Insérer des données de dépense pour le mois de février 2024
INSERT INTO "public".depense (id_type_depense, prix, date_depense)
VALUES
    (1, 100.50, '2024-02-05'),
    (2, 70.75, '2024-02-20');

-- Insérer des données de dépense pour le mois de mars 2024
INSERT INTO "public".depense (id_type_depense, prix, date_depense)
VALUES
    (1, 90.00, '2024-03-10'),
    (2, 65.25, '2024-03-25');

-- Insérer des données de dépense pour le mois d'avril 2024
INSERT INTO "public".depense (id_type_depense, prix, date_depense)
VALUES
    (1, 85.00, '2024-04-12'),
    (2, 55.50, '2024-04-27');

-- Insérer des données de dépense pour le mois de mai 2024
INSERT INTO "public".depense (id_type_depense, prix, date_depense)
VALUES
    (1, 95.75, '2024-05-15'),
    (2, 60.00, '2024-05-30');
